...
const Register = () => {
  ...
  return (
     <div  className='h-[50%] w-[30%] m-auto rounded bg-white  items-center mt-20 flex flex-col gap-5 p-6'>
      <h1 className='text-2xl font-bold text-center'>Register Form</h1>

        <form onSubmit={handleSubmit(handleRegisterFormSubmit)}  action="" className='flex flex-col gap-4 '>
      ...
      <p>Already have an account <span className='text-blue-500 cursor-pointer' onClick={()=>setToggle(false)} >Login here</span></p>
    </div>
  )
}
