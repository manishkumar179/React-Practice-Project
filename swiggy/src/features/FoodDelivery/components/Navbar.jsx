...
const Navbar = () => {
  return (
    <div className="flex shadow-md justify-between px-[10vw] items-center h-[10%]">
      <div>
      ...
      <div className="flex items-center gap-10">
        <p className="text-sm font-semibold">Swiggy Corporate</p>
        <p className="text-sm font-semibold">Search</p>
        <p className="text-sm font-semibold">Offers</p>
        <p className="text-sm font-semibold">Helps</p>
